...
projects = [
    ...
    ("Parallel Performance Analysis Tools | Python, OpenMP, MPI, HPCToolkit, Caliper, Hatchet", [
        ...
        "Wrote cluster-compatible Bash scripts to automate job submission and environment setup, integrating module loading and directory handling.",
        ...
        "Implemented robust resource allocation strategies, managing process count and core binding for optimized parallel execution.",
